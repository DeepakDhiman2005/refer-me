...
const Footer = () => {
  ...
  const courses = [
    "Data Science Course", "Cybersecurity Course", "Data Analytics Course",
    "AI and Machine Learning Course", "Cloud Computing Course", "Blockchain Course","Cloud Computing Course", "Blockchain Course"
  ];

  const resources = [
    "Course Info", "Tutorials", "Interview Questions", "Practice Tests", "Master Classes", "Blogs"
  ];

  const offerings = [
    "Live virtual (online)", "Classroom", "Agile Services", "Refer & Earn", "Corporate Training", "School Training", "Industrial Training", "IT Training"
  ];

  const topCategories = [
    "Technology", "Business", "Marketing", "Design", "Data Science", "Cybersecurity", "AI & Machine Learning", "Cloud "
  ];

  const partners = [
   "Become an instructor", "Hire from Us", " Become a Training Partner", "Affiliates"
  ];
  ...
  const supportLegal = [
    "Privacy Policy", "Terms & Conditions", "Refund Policy", "Cookies Policy","FAQs","Sitemap"
  ];
